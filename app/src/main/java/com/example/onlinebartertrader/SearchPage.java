        ...
        preferenceRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    spin.setOnItemSelectedListener(SearchPage.this);
                    ArrayAdapter<String> aa = new ArrayAdapter<>(SearchPage.this, android.R.layout.simple_spinner_item, preferences);
